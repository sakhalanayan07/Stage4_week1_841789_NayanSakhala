...
import com.cognizant.springlearn.HandsOn5RestGetCountryExceptionalScenario;
...
public class CountryController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(HandsOn5RestGetCountryExceptionalScenario.class);
