...
import com.cognizant.springlearn.HandsOn6MockMVC_TestGetCountryService;
...
public class CountryController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(HandsOn6MockMVC_TestGetCountryService.class);
