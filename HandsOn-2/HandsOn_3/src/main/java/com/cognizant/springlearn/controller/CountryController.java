...
import com.cognizant.springlearn.HandsOn4RestGetCountryBasedOnCountryCode;
...
public class CountryController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(HandsOn4RestGetCountryBasedOnCountryCode.class);
